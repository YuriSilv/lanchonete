...
public class Pedidos{
    ...
    private Calendar dataTesteCalendar;
    ...
    public Pedidos(float valorTotal, String cpf) {
        this.dataTesteCalendar = Calendar.getInstance();
    ...
    public Calendar getDataTesteCalendar() {
        return dataTesteCalendar;
    }

    public void setDataTesteCalendar(Calendar dataTesteCalendar) {
        this.dataTesteCalendar = dataTesteCalendar;
    }
